...
def train_cnn(a_cnn, X_train, Y_train, X_test, Y_test, batch_size, epochs):
    ...
    Return:
        ...
        Returns: The logs of the training
...
if __name__ == '__main__':
    ...
    history = train_cnn(my_cnn, X_train, Y_train, X_test, Y_test, 100, 50)
